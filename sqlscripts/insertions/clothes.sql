INSERT INTO clothes ( id, fk_resident_id, fk_pattern_id, fk_colour_name, density, fk_type_name )
    VALUES
        ...
        ( DEFAULT, NULL,  4, "Apricot", 483, "обувь" ),

        ( DEFAULT, NULL,  5, "Peach", 477, "головной убор" ),
        ( DEFAULT, NULL,  6, "Melon", 498, "торс" ),
        ( DEFAULT, NULL,  7, "YellowOrange", 609, "поножи" ),
        ...
        ( DEFAULT, NULL,  3, "Red", 477, "головной убор" ),
        ( DEFAULT, NULL,  4, "OrangeRed", 498, "торс" ),
        ( DEFAULT, NULL,  5, "RubineRed", 609, "поножи" ),
        ( DEFAULT, NULL,  6, "WildStrawberry", 838, "кольцо" ),
        ( DEFAULT, NULL,  7, "Salmon", 483, "обувь" ),

        ( DEFAULT, NULL,  8, "CarnationPink", 477, "головной убор" ),
        ...
        ( DEFAULT, NULL,  3, "Lavender", 609, "поножи" ),
        ( DEFAULT, NULL,  4, "Thistle", 838, "кольцо" ),
        ( DEFAULT, NULL,  5, "Orchid", 483, "обувь" );
